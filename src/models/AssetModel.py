...
class AssetModel(BaseDataModel):
    ...
    def __init__(self, db_client: object):
        ...
        self.collection = self.db_client[
            DataBaseEnum.COLLECTION_ASSEST_NAME.value
        ]

    # Async factory method: creates a ready-to-use instance because __init__ cannot use await
    @classmethod
    ...
    async def init_collection(self):
        ...
        if DataBaseEnum.COLLECTION_ASSEST_NAME.value not in all_collections:
            self.collection = self.db_client[
                DataBaseEnum.COLLECTION_ASSEST_NAME.value
            ]
